...
precompile(Tuple{Type{Base.Generator{I, F} where F where I}, Base.var"#315#316", Array{Any, 1}})
precompile(Tuple{typeof(Base.collect_similar), Array{Any, 1}, Base.Generator{Array{Any, 1}, Base.var"#315#316"}})
...
precompile(Tuple{CSV.var"##read#77", Bool, Base.Iterators.Pairs{Union{}, Union{}, Tuple{}, NamedTuple{(), Tuple{}}}, typeof(CSV.read), String, Type})
