...
oT, oV, oP = pre_adp(Tt, 0.5*rand(9), PM; flag_v = true, flag_t = false);
...
#Тест_3
Tt = [0.6, 0.54, 0.31, 0.74, 0.35, 0.05, 0.54, 0.53, 0.17]#rand(0.01:0.01:1, nw)
mV = ones(nw)
bet = (3.7e-4 + 7.4e-3)/2;
...
oT, oV, oP = pre_adp(rand(9), 0.5*rand(9), PM;
                    flag_v = true, flag_t = true, maxI = 250);
