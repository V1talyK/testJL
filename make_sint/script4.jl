...
for iw in [wg1, wg2, wg3, wg4]
    BHPT[iw,yst[6]] .= Pw_prod+10;
    BHPT[iw,yst[7]] .= Pw_prod+10;
end

for t = 6:7
    BHPT[33,yst[t]] .= Pw_inj;
    BHPT[34,yst[t]] .= Pw_inj;
    BHPT[36,yst[t]] .= Pw_inj;
end

#Восьмой - Десятый год
for ts = yst[8:10]
    for iw in [wg1, wg2, wg3, wg4]
        BHPT[iw,ts] .= Pw_prod+10;
    end
    BHPT[33,ts] .= Pw_inj;
    BHPT[34,ts] .= Pw_inj;
    BHPT[35,ts] .= Pw_inj;
